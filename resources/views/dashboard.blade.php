        ...
        <section class="mt-7" aria-labelledby="agent-dashboard-heading">
            <div class="flex flex-wrap items-end justify-between gap-4">
                <div>
                    ...
                    <h2 id="agent-dashboard-heading" class="mt-2 text-xl font-extrabold tracking-tight text-[#263a43]">Antrean dan tanggung jawab operasional</h2>
                ...
                <div class="flex flex-wrap gap-2">@if ($agentDashboard['is_tier_one'])<a href="{{ route('tickets.queue') }}" class="ui-btn ui-btn-secondary">Buka antrean Tier 1</a>@endif<a href="{{ route('tickets.index') }}" class="ui-btn ui-btn-ghost">Tiket tanggung jawab saya</a></div>
            </div>

            <div class="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
                @if ($agentDashboard['is_tier_one'])<article class="ui-stat-card items-start"><span class="ui-stat-icon" aria-hidden="true">▤</span><div><p class="ui-stat-label">Antrean Baru</p><p class="ui-stat-value">{{ $agentDashboard['queue_count'] }}</p><p class="mt-1 text-xs leading-5 text-[#78909a]">Menunggu klaim Tier 1.</p></div></article>@endif
