...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::group([], function () {
        ...
        Route::get('/reports/monthly/export/excel', [ReportController::class, 'exportExcel'])->name('reports.monthly.excel');
        Route::get('/reports/monthly/export/pdf', [ReportController::class, 'exportPdf'])->name('reports.monthly.pdf');
